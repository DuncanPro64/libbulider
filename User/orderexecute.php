...
{
$msg = "".$ex->errorMessage()."";
$mail->Password ="@MichaelPrince";
//$mail->SetFrom('mulongodancan25@gmail.com','Pyrum');
...
"Payable amount: $phone_number\n ".
"Delivery Method: $phone_number\n".
"Payment Method: $phone_number\n ".
...
mail($mail_To, $mail_Subject, $mail_Body);
 ...
 <script>
    ...
    echo "Error: ".$order1."<br />". $con->error;
            ...
            $service_Id = $service['material_id'];

                echo "
                <body style='background:;border:1px solid grey; width:95%;'>
                <div class='alert alert-warning tex-center' style='margin-left:10%;color: orange; width: 70%; text-align: center;height: 10%;'>TRANSACTION PAGE</div>
            <form class='border-warning border-light p-5' method='post' style='background:; border-radius:5px;padding: 5px;margin_left:10%;border: 1px solid  orange;margin-top:5%;font-size:10px;background-image:url('duncan.png');'>
<div class='input'>
<p style='margin_left:50%;text-align:center;color:orange;'> Enter Your Details...</p><hr style='back-color:orange;'>
      <input  class='border border-light p-2' type='text' id='email_address' name='email_address' placeholder='Enter your email...' required>
            ...
            <input class='border border-light p-2' type='number'  name='phone_number' placeholder='Enter your phone number...'>
             ...
             <input  class='border border-light p-2' type='text' name='physical_address' placeholder='Enter your physical_address.' required>
              <input  class='border border-light p-2' type='number' name='quantity' placeholder='Enter your number of items...' required>
              <input  class='border border-light p-2' type='text' id='address1' name='address1' placeholder='8.90099' >
               <input class='border border-light p-2' type='text' id='address2' name='address2' placeholder='6.899900'>
                ...
                border:1px solid rgba(0,0,0,.1); width:30%; margin-left:35%;font-size:10px;margin-top:5px; border-radius:5px;' >
                    ...
                    <div class='text-center mt-2'>
                        ...
                        <button type='submit' name='book' id='book' value='book' style='width:;height:6.5%;' class='btn btn-warning'/> Order </button> 
                    </div>
                </div>
            
    <a href=' ' style='width: 20px; height: 30px;margin-left:43%;'>  <img src='visa.png' alt='gmail' class='social-icon'><img src='paypal.png' alt='gmail' class='social-icon'><img src='mastercard.png' alt='gmail' class='social-icon'><img src='mpesa1.png' alt='gmail' class='social-icon'>  </a>
