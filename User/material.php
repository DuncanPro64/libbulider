...
<body>
    ...
    <main>
        <!-- material section  -->
        <section class="material-sect" style="background-image: url('back1.png');">
            <h2>Material</h2>
          <article class="art-text" ><h3 style="color: orange;font-size: 18px;">Here are our construction materials. You can buy any of them.</h3></article>
            <div class="materials">
                      <?php
