...
while($rr=mysqli_fetch_array($rer3)){
    ?>
      <div class="swiper-slide" style="background-image:url(../images/<?php echo $rr['profile_pic'] ?>)"><h3 class="text"><span style="display:block;"><?php  echo $rr['description']?></span ></h3></div>
...
while($rr1=mysqli_fetch_array($rer5)){
    ?>
      <div class="swiper-slide" style="background-image:url(../images/<?php echo $rr1['profile_pic']; ?>"></div>
       <?php } ?>
    </div>
  </div>
