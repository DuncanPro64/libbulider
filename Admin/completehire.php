...
$today=date("jY",time());
 ...
 $order1=mysqli_query($con,"INSERT INTO transaction(transaction_id,rawcust_id, rawmat_id,transaction_number,transaction_date,total_price,balance, status) VALUES ('$transaction_id','$email_address','$equipment_id' ,'$transaction_number','$transaction_date','$total_price','0', '$status')");
    ...
    echo "<div class='alert alert-success tex-center' style='width: 30%; margin-left: 34%;margin-top: 5%;text-align:center; background-color:#dff0d8;color:#3c763d;'>The Transaction completed successfully<br> A receipt has been send to the Email address provided.<img src='icons/action_check.gif' alt='image' class='photo' style='width: 20px; height: 20px;border-radius: 300px; margin-top: 1px;' style='align-text:center;'><br> <a href='notifications.php'>Home</a></div>
                ";
  }
