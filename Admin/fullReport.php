...
$from=$_GET['from'];
$to=$_GET['to'];
$query5 = mysqli_query($db, "select count(*) as total from transaction  where transaction_date between '$from' and '$to'");
$result5 = mysqli_fetch_array($query5);
$result=mysqli_query($db,"SELECT c.material_name,c.unit_price, o.rawmat_id,o.rawcust_id, o.transaction_number,o.transaction_id, o.transacted_at,o.transaction_date,o.balance, o.total_price,o.quantity FROM material AS c
...
<form style="margin-left: 30%;">
  ...
  <button id="date"name="date" style="height: 30px;width: 100px;border:1px solid grey;border-radius: 5px;">GENERATE</button>
</form>
<br></div>
