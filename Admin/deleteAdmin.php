...
$id = $_GET['service_Id'];
   if (isset($_POST['delete'])){
        ...
        $users=mysqli_query($con ,"DELETE FROM admin WHERE username='$id'");

if ($users) {
   
   echo "<div class='alert alert-success tex-center' style='width: 30%; margin-left: 34%;margin-top: 5%;text-align:center;'>Admin was Deleted Successfully.<img src='icons/action_check.gif' alt='image' class='photo' style='width: 20px; height: 20px;border-radius: 300px; margin-top: 1px;' style='align-text:center;'><br> <a href='manageAdmin.php'>Home</a></div>
               ";
}
else{
    echo "Error: ".$users."<br />". $con->error;
            ...
            <form method='post'>
                ...
                <h4 class='text-center'>Confirm Admin Deletion!</h4>
                <img src='icons/icon_error1.gif' alt='image' class='photo' style='width: 30px; height: 30px;border-radius: ; margin-top: 3px; '><br>
                    You have requested to delete <br>Fist Name: <b>$service_tag</b>,<br> Username.  :<tt class='font-italic font-weight-bold'>$service_Id</tt>.<br> Are you sure?
                    <div class='text-center mt-2'>
                    
                        <a href='manageAdmin.php' class='btn btn-success'>Cancel</a>
