...
class PDF extends TCPDF {
	...
	public function Header() {
		...
		$this->Cell(189,3,'HIRE REPORT TODAY',0,1,'C');
...
$pdf->SetTitle('HIRE REPORT TODAY');
...
$pdf->Cell(31,5,'CUSTOMER ID',1,0,'C',1);
...
//data iteration
   $today=date('Y-m-d'); 
$result2=mysqli_query($con,"SELECT o.equipment_name,o.unit_price, o.rawequ_id,p.hire_id,p.hire_number,p.rawequ_id,p.total_price,p.date_hired,p.rawcust_id FROM equipment AS o
 INNER JOIN hire AS p
 ON o.rawequ_id=p.rawequ_id
WHERE p.date_hired='$today'
 ORDER BY o.equipment_name, p.hire_number; ");
...
while($row = mysqli_fetch_array($result2))
 ...
 }><td style="border:1px dotted black;">'.$hire_number.'</td> <td style="border:1px dotted black;">'.$rawcust_id.'</td><td style="border:1px dotted black;">'.$equipment_name.'</td> <td style="border:1px dotted black;">'.$quantity.'</td><td style="border:1px dotted black;">'.$unit_price.'.00</td><td style="border:1px dotted black;"> '.$price.'.00</td>
        </tr> ';
