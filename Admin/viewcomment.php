        ...
        <?php while ($row=mysqli_fetch_array($result)){
          ?>
            ...
            <td> <b><?php echo $row['first_name']; ?> <?php echo $row['last_name']; ?></b>: wrote a below<br><b>SUBJECT: </b><?php echo $row['subject']; ?><br><b>Description: </b> <?php echo $row['description']; ?></td>
              <td style="text-align: left;">  <a href="https://<?php  $row['email_address']; ?>" style='text-decoration: none; color: blue;'><?php echo $row['email_address']; ?></a>  /<?php echo $row['phone_number']; ?> </td>
