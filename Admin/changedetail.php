...
include'loginExec.php';
  ...
  $user=mysqli_query( $con,"UPDATE admin SET first_name='$firstname', last_name='$lastname', password='$password' WHERE username='$username'");
...
<?php
 if(isset($errfirstname)){
          echo "<div class='error'>$errfirstname</div>";
        }
        ?>
        <?php
     if(isset($errlastname)){
          echo "<div class='error'>$errdlastname</div>";
        }
        ?>
        <?php
