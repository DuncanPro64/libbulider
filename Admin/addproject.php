...
<div class="header" style="margin-left:15%;color: orange; width: 70%; text-align: center; background: grey;height: 5%;">YOUR PROJECTS</div>
              ...
              <td><?php echo $row['start_date']; ?></td>
               <td><?php echo $row['end_date']; ?></td>
                 <td><?php echo $row['category_id']; ?></td>
                    ...
                    <div class="el-card-avatar el-overlay-1"><a href="editProfile.php?service_Id=<?php echo $row['count_id'];?>" class= "edit-btn"> <img  style="width:30px; height: 20px; " src="http://localhost/dun3//images/<?php echo $row['profile_pic'];?>" /></a></div></div></td>
               <td><a href="EditProject.php?edit=<?php echo $row['count_id'];?>" class= "edit-btn"> <img src="../icons/icon_content_small.gif" alt="image" class="photo" style="width: 20px; height: 20px;border-radius: 300px; margin-top: 1px;"></a></td>
               <td><a href="deleteProject.php?count_id=<?php echo $row['count_id'];?>" class= "edit-btn"> <img src="../icons/action_delete.gif" alt="image" class="photo" style="width: 20px; height: 20px;border-radius: 300px; margin-top: 1px;"></a></td>
             </tr>
           <?php }?>
