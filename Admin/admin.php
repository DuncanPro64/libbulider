...
<head>
    ...
    <link rel="stylesheet" href="../User/common.css">
...
while($row=$res1->fetch_assoc()){
 ...
 ORDER BY c.material_name, o.transaction_date ASC; ");   
...
<div class="today" style="border-top: 2px solid orange;background-image: url('../User/back.png');">
