...
$today=date("jY",time());
 ...
 $order1=mysqli_query($con,"INSERT INTO transaction(transaction_id,rawcust_id, rawmat_id,transaction_number,transaction_date,quantity,total_price, status) VALUES ('$transaction_id','$email_address','$material_id' ,'$transaction_number','$transaction_date','$quantity','$total_price', '$status')");
    ...
    $order4=mysqli_query( $con,"UPDATE material SET quantity=quantity-1 WHERE rawmat_id = '$material_id'")or die(mysqli_error($con));
     ...
     echo "<div class='alert alert-danger tex-center' style='width: 30%; margin-left: 34%;margin-top: 5%;text-align:center; '>YOU ARE NOT ALLOWED TO MAKE ANY TRANSACTION <br> CONSULT YOUR SUPER ADMIN OR ACCOUNTANT.<img src='../icons/icon_error1.gif' alt='image' class='photo' style='width: 20px; height: 20px;border-radius: 300px; margin-top: 1px;' style='align-text:center;'> <link rel='stylesheet' type='text/css' href='../bootstrap/css/bootstrap.min.css'><br> <a href='addtransaction.php'>Home</a></div>
               ";
    exit();
  }
