...
<img src="../images/<?php echo $image ?>" style="height: 50%; width: 64.8%; margin-left: 25%;margin-top: 5%;">
<form action="editAprofileExec.php" method="post" enctype="multipart/form-data" style="margin-left: 25%; color: green;background: orange; align-items: center;width: 50%;padding-left: 15%;font-size: 20px; font-family: verdana;">
	<br>
