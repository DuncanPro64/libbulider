...
require_once('../tcpdf/tcpdf.php');
    ...
    include_once("../classes/Constant.php");
            ...
            $result2 = mysqli_query($con, "SELECT * FROM myorder LIMIT 12 ");
...
$pdf->SetTitle('ORDER REPORT TODAY');
...
//data iteration
   $today=date('Y-m-d'); 
$result2=mysqli_query($con,"SELECT c.material_name,c.unit_price, o.rawmat_id,o.email_address, o.raword_id,o.order_number,o.order_date,o.order_id, o.ordered_at, o.total_price,o.order_id FROM material AS c
...
while($row = mysqli_fetch_array($result2))
 ...
 }><td style="border:1px dotted black;">'.$order_number.'</td> <td style="border:1px dotted black;">'.$order_id.'</td><td style="border:1px dotted black;">'.$material_name.'</td> <td style="border:1px dotted black;">'.$total_price.'</td><td style="border:1px dotted black;">'.$unit_price.'.00</td><td style="border:1px dotted black;"> '.$price.'.00</td>
        </tr> ';
